...
@section('title', 'SISALRIL - Esquema 33')
...
<div class="space-y-6 font-sans animate-fade-in text-xs">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between pb-5 border-b border-slate-100 gap-4">
        <div>
            <h2 class="text-xl font-bold text-slate-900 tracking-tight">SISALRIL - Esquema 33</h2>
            <p class="text-xs text-slate-500 font-medium">Esquema 33: Titulares voluntarios.</p>
        </div>
    ...
    <div class="bg-white rounded-3xl border border-slate-100 p-6 shadow-xs space-y-4 animate-fade-in">
        <div class="flex items-center justify-between border-b border-slate-50 pb-3">
            <h3 class="font-bold text-slate-800">Registros del Reporte Regulatorio - Esquema 33</h3>
            <form action="/core/sisalril/exportar/33" method="POST">
                @csrf
