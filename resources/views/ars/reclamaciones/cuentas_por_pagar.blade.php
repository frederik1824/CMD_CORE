...
<div class="space-y-6 font-sans animate-fade-in text-xs">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between pb-5 border-b border-slate-100 gap-4">
        <div>
            <h2 class="text-xl font-bold text-slate-900 tracking-tight">Cuentas por Pagar (CXP)</h2>
            <p class="text-xs text-slate-500 font-medium">Reporte consolidado de cuentas por pagar.</p>
        </div>
