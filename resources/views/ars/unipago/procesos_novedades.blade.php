@extends('layouts.ars')
@section('title', 'Procesos de Novedades Unipago')
@section('content')
<div class="space-y-6 font-sans text-xs">
    <div class="flex items-center justify-between pb-4 border-b border-slate-100">
        <div>
            <h2 class="text-xl font-bold text-slate-900 tracking-tight">Procesos de Novedades (Dependientes)</h2>
            <p class="text-xs text-slate-500 font-medium">Bandeja de transmisión de novedades y cargas familiares.</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-3xl border border-slate-100 p-6 shadow-xs space-y-4 animate-fade-in">
        <h3 class="font-bold text-slate-800">Lotes de Novedades de Dependientes</h3>
